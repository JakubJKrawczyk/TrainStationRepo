...
const firstGroup = '#1b1bb8'
const secondGroup = '#4747d6'
const thirdGroup = '#ba1e1e'
const fourthGroup = '#dc4e1c'
const fifthGroup = '#100f0f'
const sixthGroup = '#198e19'
const seventhGroup = '#25b4bc'
type StationColor = {
  name: string
  color: string
  border: string
...
export class GlobalConst {
  ...
  static DiscriminantsLegend: { [key: string]: StationColor } = {
    ...
    LPO: {
      name: 'ogólnodostępna bocznica szlakowa i przystanek osobowy',
      color: firstGroup,
      border: 'dotted'
    }, // Pink
    PBSP: {
      name: 'posterunek bocznicowy szlakowy i przystanek osobowy',
      color: firstGroup,
      border: 'dotted'
    }, // Light Blue
    ...
    ODGS: {
      name: 'posterunek odgałęźny i przystanek służbowy',
      color: thirdGroup,
      border: 'dotted'
    }, // Light Green
    PGL: { name: 'posterunek odgałęźny i ładownia', color: thirdGroup, border: 'solid' }, // Lime Green
    PGLP: {
      name: 'posterunek odgałęźny, przystanek osobowy i ładownia',
      color: thirdGroup,
      border: 'dotted'
    }, // Deep Orange
    ...
    PK: {
      name: 'przystanek osobowy w kolejowej komunikacji autobusowej',
      color: seventhGroup,
      border: 'none'
    }, // Light Orange
    PO: { name: 'przystanek osobowy publiczny', color: seventhGroup, border: 'none' }, // Aquamarine
    POGT: {
      name: 'przystanek osobowy i grupa torów towarowych',
      color: seventhGroup,
      border: 'dotted'
    } // Bright Light Green
  }
